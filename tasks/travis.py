...
class Test(BaseTest):
    ...
    def download_rpython(self):
        invoke.run("wget https://bitbucket.org/pypy/pypy/get/precise-instantiate.tar.bz2 -O `pwd`/../pypy.tar.bz2 || wget https://bitbucket.org/pypy/pypy/get/precise-instantiate.tar.bz2 -O `pwd`/../pypy.tar.bz2")
